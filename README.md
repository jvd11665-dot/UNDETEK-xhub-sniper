...
PlaceId `109397169461300` · **Combat v8.27** · **Autofarm v2.12**

[-- Two scripts --]
[+] `script.lua` — **combat only** v8.27 (ADS 24/7 · trigger · peek L/R · predict · cible smart)
...
5. Si **>250 studs** du lobby → charge combat (`?v=827`)
6. **Combat OFF** au lobby · fin de match → RETURN TO LOBBY

[-- Combat v8.27 --]
[+] ADS **24/7** dès le boot
[+] Trigger + wallbang · predict renforcé
[+] Derrière mur: peek léger L/R · cible proche / qui approche
[+] ESP / cibles **max 250 studs** · auto-reload 5 balles
[+] Bot unique intelligent

[-- Links --]
GitHub: https://github.com/jvd11665-dot/UNDETEK-xhub-sniper
+ info: https://github.com/jvd11665-dot/UNDETEK-xhub-sniper
Combat: https://raw.githubusercontent.com/jvd11665-dot/UNDETEK-xhub-sniper/main/script.lua?v=827
Autofarm: https://raw.githubusercontent.com/jvd11665-dot/UNDETEK-xhub-sniper/main/autofarm.lua?v=212

[-- Loadstring combat --]
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/jvd11665-dot/UNDETEK-xhub-sniper/main/script.lua?v=827"))()
```
